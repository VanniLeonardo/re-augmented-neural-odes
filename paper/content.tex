...
\textbf{1.74} between 25 and 500 epochs, the range of the condition we recorded in advance.
That of the augmented model grows by \textbf{1.04}. At the original
...
the cost of the flow rather than by accuracy. The pattern repeats on the thinner circles geometry, with growth factors of 1.37 and 1.04. One of those fifty runs stopped at 271 of its 500 epochs under a wall-clock cap. We include
...
all five seeds. Restricted to the four seeds that pass the check at both ends of the sweep, the growth factor of the Neural ODE is 1.37, so the effect holds without them. That this
equals the circles value above is a coincidence.
