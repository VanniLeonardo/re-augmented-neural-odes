...
\textbf{1.37} between 25 and 500 epochs, over the four seeds that pass the reconstruction check
at both ends. That range of budgets is the one the condition we recorded in advance names. That of the augmented model
grows by \textbf{1.04}, over all five. At the original
...
them the most extreme instances of the effect under study. Over all five seeds, including those three, the Neural ODE factor is
1.74. We report that figure and do not let it carry the comparison, because a measurement that
...
\begin{table}[h]
  ...
  \begin{tabularx}{\linewidth}{@{}clX@{}}
    ...
    2 & reproduced & NFE growth of $\times1.37$ against $\times1.04$ on the seeds that
        pass the check at both ends, and $\times1.74$ over all five \\
