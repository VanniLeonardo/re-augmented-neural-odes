...
corrected value of about 0.8 therefore remains unexplained: neither the adjoint tolerance, nor
the stiff-capable solvers we could run, nor the error norm accounts for it.
...
complete on the convolutional field. We can therefore state that, within our configuration, the ratio is dominated by the adjoint
tolerance and is not reduced by the stiff-capable solvers we could run. The original's logs now
give its value in its own configuration, about 0.8, but we have not run VODE on our fields.
